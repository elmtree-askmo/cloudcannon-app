...
content_blocks:
  - _bookshop_name: plans/intro
    ...
    description: 
      ...
      fr: 
      sp: >-
        En QuickTakes estamos comprometidos a mantener la tecnología de punta en educación accesible para todos, es por eso que siempre ofreceremos una versión gratuita del servicio a nuestros usuarios. Tenemos múltiples opciones de suscripción.disponible en incrementos de 3 y 6 meses, ya sea que utilice QuickTakes todos los días o con menos frecuencia. Para comprar, inicie sesión en QuickTakes (en la web o mediante aplicaciones móviles) y vaya a la pestaña Tienda.
  ...
  - _bookshop_name: plans/contact
    ...
    description: 
      en: >-
        Are you a university or institution interested in licensing QuickTakes for
        your students or employees? Email us at ${email}
      zh_hk: >-
        若 貴校/ 貴機構有興趣為您的學生或員工授權使用 QuickTakes。請發送電子郵件至 ${email}
      fr: 
      sp: >-
        ¿Es usted una universidad o institución interesada en otorgar licencias de QuickTakes para sus estudiantes o empleados? Envíenos un correo electrónico a ${email}
    buttontxt: 
      en: Email Us
      zh_hk: 以電子郵件聯絡我們
      fr: 
