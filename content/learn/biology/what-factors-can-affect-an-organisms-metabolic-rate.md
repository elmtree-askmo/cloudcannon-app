...
seo:
  ...
  page_description: >-
    This content discusses the various intrinsic and extrinsic factors that influence an organism's metabolic rate, including age, body size, temperature, food availability, climate, activity level, reproductive status, and physiological adaptations.
  page_keywords: >-
    metabolic rate, factors affecting metabolism, age, body size, temperature, food availability, climate, habitat, activity level, reproductive status, physiological adaptations
author: QuickTakes
question: >-
