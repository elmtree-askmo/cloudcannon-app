...
seo:
  ...
  page_description: >-
    The dot product, also known as the scalar product, is an essential vector operation that combines two vectors to yield a scalar quantity, with applications in calculating angles between vectors, projections, and work done in physics.
  page_keywords: >-
    dot product, scalar product, vector mathematics, angle between vectors, vector projection, work done by a force, mechanical systems, energy transfer, components of forces, physics, engineering, mathematical definition
author: QuickTakes
question: >-
...
url: /learn/engineering/questions/define-the-dot-product-and-explain-how-it-is-used-to-calculate-scalar-products
---
