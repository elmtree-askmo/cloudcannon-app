...
seo:
  ...
  page_description: >-
    This content explains the symbols used in flowcharts, particularly the terminal symbol represented by an oval shape, which indicates the start and end of a process.
  page_keywords: >-
    flowcharts, terminal symbol, oval shape, start, end, process symbols, decision symbols, input/output symbols, subroutine symbol, flow lines, visualizing algorithms
author: QuickTakes
question: >-
