...
seo:
  ...
  page_description: >-
    This content explains the preferred format for representing IPv6 addresses, including their structure, case sensitivity, examples, and rules for abbreviation.
  page_keywords: >-
    IPv6, address representation, hexadecimal format, network configuration, 128 bits, groups, hextets, colons, case sensitivity, abbreviation, double colon, leading zeros
author: QuickTakes
question: >-
