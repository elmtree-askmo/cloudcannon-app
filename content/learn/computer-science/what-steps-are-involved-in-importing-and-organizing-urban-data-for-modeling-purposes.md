...
seo:
  ...
  page_description: >-
    This content outlines the steps involved in importing and organizing urban data for modeling purposes using tools like Rhino and Grasshopper, including access to urban datasets, data organization, visualization, and analysis.
  page_keywords: >-
    urban data, modeling, Rhino, Grasshopper, open data portals, GIS datasets, data import, data organization, spatial analysis, 3D visualization, parametric design
author: QuickTakes
question: >-
    What steps are involved in importing and organizing urban data for modeling purposes?
answer: >-
