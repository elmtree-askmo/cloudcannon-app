...
seo:
  ...
  page_description: >-
    This content explains the differences between well-known, registered, and private port numbers in networking, detailing their ranges and functions.
  page_keywords: >-
    port numbers, well-known ports, registered ports, private ports, dynamic ports, IANA, networking, service identification, HTTP, HTTPS, FTP, RADIUS, network services
author: QuickTakes
question: >-
