...
seo:
  ...
  page_description: >-
    This content explains how FTP clients and servers interact during file transfer, detailing the steps involving connection establishment, authentication, command execution, and data transfer.
  page_keywords: >-
    FTP, File Transfer Protocol, FTP client, FTP server, file transfer, TCP connections, control connection, data connection, authentication, active mode, passive mode, command execution, LIST, RETR, STOR, network protocol
author: QuickTakes
question: >-
