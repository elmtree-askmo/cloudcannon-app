...
seo:
  ...
  page_description: >-
    This content explains the command used to display a legal notification message on a router, detailing how to set a Message of the Day (MOTD) banner and the method to save the configuration.
  page_keywords: >-
    router, legal notification, command, banner motd, Message of the Day, configuration mode, delimiters, Unauthorized access, save configuration, NVRAM
author: QuickTakes
question: >-
