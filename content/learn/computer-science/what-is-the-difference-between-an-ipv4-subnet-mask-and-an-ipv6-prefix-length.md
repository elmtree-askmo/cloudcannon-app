...
seo:
  ...
  page_description: >-
    This content explains the differences between IPv4 subnet masks and IPv6 prefix lengths, covering their formats, functions, and how they define the network and host portions of IP addresses.
  page_keywords: >-
    IPv4, subnet mask, IPv6, prefix length, network portion, host portion, CIDR notation, representation, binary, Stateless Address Autoconfiguration, subnetting, dotted-decimal format
author: QuickTakes
question: >-
