...
seo:
  ...
  page_description: >-
    This content explains how the host portion of an IPv4 address is represented in dotted decimal format, including its relation to the network portion and the use of subnet masks.
  page_keywords: >-
    IPv4 address, host portion, dotted decimal format, network portion, subnet mask, octets, 32-bit number, network identification, device addressing
author: QuickTakes
question: >-
