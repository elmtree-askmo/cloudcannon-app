...
seo:
  ...
  page_description: >-
    This content describes a non-example of mathematical induction using the Fibonacci sequence, illustrating the false statement that all Fibonacci numbers are even and showing the failure at the base case.
  page_keywords: >-
    Fibonacci sequence, induction, non-example, even numbers, base case, inductive step, false statement, proof failure, natural numbers
author: QuickTakes
question: >-
