...
seo:
  ...
  page_description: >-
    This content explains the differences between the outputs of an original function and its transformed version, particularly focusing on reflection over the x-axis, illustrating with examples and visual representations.
  page_keywords: >-
    function transformations, reflection over x-axis, original function, transformed version, outputs comparison, y-values inversion, graphical representation, function examples, parabola, mathematical transformations
author: QuickTakes
question: >-
