...
seo:
  ...
  page_description: >-
    The exclusive-or operator (XOR) is a logical operator in propositional logic that returns true when exactly one of its propositions is true. It's used in various fields like computer science and cryptography.
  page_keywords: >-
    exclusive-or, XOR, logical operator, propositional logic, truth table, disjunction, computer science, cryptography, digital logic, decision making
author: QuickTakes
question: >-
