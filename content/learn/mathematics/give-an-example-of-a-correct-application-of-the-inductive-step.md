...
seo:
  ...
  page_description: >-
    This content illustrates the correct application of the inductive step in proving that the sum of the first n odd integers is equal to n^2 using mathematical induction.
  page_keywords: >-
    inductive step, mathematical induction, proof, first n odd integers, k, k+1, base case, induction hypothesis, n^2, sum of integers
author: QuickTakes
question: >-
