...
seo:
  ...
  page_description: >-
    The Fibonacci sequence is defined recursively with base cases F(0) = 0 and F(1) = 1, and for n > 1, F(n) = F(n-1) + F(n-2). This shows how each term is generated by its predecessors.
  page_keywords: >-
    Fibonacci sequence, recursive definition, base cases, recursive case, Fibonacci numbers, recursion, mathematical theory, programming, memoization, iterative approaches, stack overflow
author: QuickTakes
question: >-
